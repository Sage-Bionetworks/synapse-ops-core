#!/bin/bash
#
# Build Synapse Account Network Load Balancers
#
...
java $CMD_PROPS -Xmx2g -cp ./target/stack-builder-0.2.0-SNAPSHOT-jar-with-dependencies.jar org.sagebionetworks.template.nlb.NetworkLoadBalancerMain
